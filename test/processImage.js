...
describe('express-processimage', () => {
  ...
  describe('with secondGuessSourceContentType=true', () => {
    ...
    it('should return the correct contentType of a wrongly named heic', () => {
      config.debug = true;
      return expect('GET /reallyaheic.png?metadata', 'to yield response', {
        body: {
          format: expect.it('to equal', 'heif'),
          contentType: expect.it('to equal', 'image/heif'),
        },
      });
    });
